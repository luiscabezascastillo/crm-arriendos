...
function SeccionEditar({ pub, id, onGuardado, edificio }) {
  const [form, setForm] = React.useState({
    ...
    has_balcony:  (pub.has_balcony === true || pub.has_balcony === 'true'),
    has_laundry:  (pub.has_laundry === true || pub.has_laundry === 'true'),
    has_maid_room: (pub.has_maid_room === true || pub.has_maid_room === 'true'),
    has_half_bath: (pub.has_half_bath === true || pub.has_half_bath === 'true'),
    has_security: (pub.has_security === true || pub.has_security === 'true'),
    hide_address: (pub.hide_address === true || pub.hide_address === 'true'),
