          ...
          <Link href='/direccion/control-asistencia' style={{ textDecoration: 'none' }}>
            <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden', cursor: 'pointer' }}>
              <div style={{ background: '#6366f1', padding: '11px 16px', display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 600, color: '#fff', flex: 1 }}>Control del personal</span>
                <GridDots />
              </div>
              <div style={{ padding: '12px 16px' }}>
                <div style={{ fontSize: 12, color: 'var(--gray-500)', marginBottom: 8 }}>Asistencia, vacaciones y ficha de cada trabajador</div>
...
<Link href="/direccion/valoraciones" style={{ textDecoration: 'none' }}>
  <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: 12, overflow: 'hidden' }}>
    <div style={{ background: palette.green.header, color: '#fff', padding: '12px 16px', fontWeight: 700, display: 'flex', alignItems: 'center', gap: 8 }}>🏠 Valoración</div>
    <div style={{ padding: 16 }}>
      <div style={{ color: '#475569', fontSize: 14, marginBottom: 12 }}>Tasación por comparables, informe PDF e historial.</div>
      <span style={{ background: palette.green.header, color: '#fff', borderRadius: 6, padding: '7px 14px', fontSize: 13, display: 'inline-block' }}>Abrir →</span>
    </div>
  </div>
</Link>
        </div>
