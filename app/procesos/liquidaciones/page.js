      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: 24, fontFamily: '"DM Sans", sans-serif' }}>
        ...
        {cargando ? <div style={{ color: '#888', padding: 20 }}>Calculando liquidación de {aammToTxt(mes)}…</div> : (
          <div style={{ background: '#fff', border: '1px solid #E8E6E0', borderRadius: 12, overflow: 'hidden' }}>
            ...
            {/* Cabecera tabla */}
            <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 0.85fr 0.85fr 0.85fr 0.95fr 0.5fr', gap: 8, padding: '9px 16px', background: '#FAFAF8', borderBottom: '1px solid #E8E6E0', fontSize: 12, color: '#888', fontWeight: 700 }}>
              <div>Propietario</div>
              ...
              return (
                <div key={p.idprop} style={{ borderTop: '1px solid #F0EEE8' }}>
                  ...
                  <div onClick={() => toggle(p.idprop)}
                    style={{ display: 'grid', gridTemplateColumns: '1.6fr 0.85fr 0.85fr 0.85fr 0.95fr 0.5fr', gap: 8, padding: '11px 16px', cursor: 'pointer', alignItems: 'center', background: abierto ? '#F5F9FF' : '#fff', fontSize: 13 }}>
