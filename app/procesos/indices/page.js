...
export default function IndicesPage() {
  ...
  async function guardar() {
    ...
    for (const k of Object.keys(edits)) {
      ...
      const ipc_3m = e.ipc_3m !== undefined ? (parseNum(e.ipc_3m) == null ? null : parseNum(e.ipc_3m) / 100) : (base.ipc_3m ?? null)
      const ipc_6m = e.ipc_6m !== undefined ? (parseNum(e.ipc_6m) == null ? null : parseNum(e.ipc_6m) / 100) : (base.ipc_6m ?? null)
      const ipc_12m = e.ipc_12m !== undefined ? (parseNum(e.ipc_12m) == null ? null : parseNum(e.ipc_12m) / 100) : (base.ipc_12m ?? null)
      ...
      payload.push({
        ...
        uf_3m: ajusteUf(k, 3), uf_6m: ajusteUf(k, 6), uf_12m: ajusteUf(k, 12),
      })
    }
    ...
    <>
      ...
      <div style={{ maxWidth: 1500, margin: '0 auto', padding: 24, fontFamily: '"DM Sans", sans-serif' }}>
        ...
        <div style={{ fontSize: 13, color: '#888', marginBottom: 16 }}>
          Solo se teclean <b>VALOR UF</b> y los tres <b>IPC</b>. Los % de ajuste y los periodos a consultar los calcula el sistema.
        </div>
            ...
            <table style={{ borderCollapse: 'collapse', width: '100%', minWidth: 1400 }}>
              <thead>
                <tr>
                  ...
                  <th style={{ ...th, background: '#DBEAFE' }}>IPC<br />3 MESES</th>
                  <th style={{ ...th, background: '#DBEAFE' }}>IPC<br />6 MESES</th>
                  <th style={{ ...th, background: '#DBEAFE' }}>IPC<br />AÑO</th>
                  ...
                  return (
                    <tr key={k} style={{ background: bg }}>
                      ...
                      <td style={{ ...td, textAlign: 'right' }}>
                        {edit
                          ? <input value={valCelda(k, 'valor_uf')} onChange={e => setCelda(k, 'valor_uf', e.target.value)} placeholder="40.823,03" style={inp(true)} />
                      ...
                      {['ipc_3m', 'ipc_6m', 'ipc_12m'].map(campo => (
                        <td key={campo} style={{ ...td, textAlign: 'right' }}>
                          {edit
                            ? <input value={valCelda(k, campo)} onChange={e => setCelda(k, campo, e.target.value)} placeholder="0,00" style={{ ...inp(true), width: 74 }} />
        ...
        <div style={{ marginTop: 14, fontSize: 12, color: '#94A3B8', lineHeight: 1.6 }}>
          Los porcentajes se escriben tal como los publica el INE: <b>2,40</b> para un 2,40 %.<br />
