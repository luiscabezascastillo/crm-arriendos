...
export async function POST(request) {
    ...
    // 1 — Marcar propiedad como web='SI' en Supabase (y activarla: publicar en cualquier portal = activa)
    if (publicacionId) {
        await supabase.from('publicaciones').update({ web: 'SI', activo: 'active' }).eq('id', publicacionId)
