// VERSION: v1 · 2026-08-12 · app/api/bb1/recuperar/route.js — Carga una operación BB1 (VENTA) del LOG para la ficha.
//   GET ?id=V00xxx. Devuelve { existe, id, hecho, model }. Reusa `lib/bb2Log.js`. Solo lectura. Gate: Dirección + Anthony.
