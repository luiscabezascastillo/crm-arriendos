...
const COLS = 'idadmon, anio, rol, comuna_sii, comuna_nombre, rut_propietario, rut_arrendatario, arrendatario, propietario, inmueble, monto_anual, meses_arrendados, falta_comuna, falta_rut_propietario, ene, feb, mar, abr, may, jun, jul, ago, sep, oct, nov, dic'
