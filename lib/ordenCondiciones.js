...
export const CORREDOR = {
  ...
  oficina: 'Ebro 2791, oficina 1B y 1C, Las Condes',
}
...
export const CONDICIONES = [
  ...
  },
  {
    ...
    texto: 'El CLIENTE y el propietario pagarán al corredor: a) 2% más IVA del valor de la transacción en compraventa; b) 2% más IVA en permuta, por cada propiedad involucrada; c) 50% más IVA de la primera renta mensual en arriendo, o 2% más IVA sobre el monto total del contrato cuando este supere los dos años; d) en arriendo con opción de compra o con promesa de compra, 2% más IVA del valor de venta convenido, pagadero a más tardar a la fecha de suscripción de la compraventa. La comisión se devenga al producirse el acuerdo entre las partes y se paga al contado al firmarse el contrato respectivo, o en la oportunidad en que debió firmarse.',
  },
  {
    n: 4, titulo: 'Cláusula penal',
    texto: 'El CLIENTE pagará, a título de multa, la comisión normal del negocio más dos veces su monto, con sus impuestos, intereses y costas (incluidos honorarios de abogados, actuarios u otros), si realiza el negocio directamente con los dueños o entrega información a un tercero para concretarlo prescindiendo del CORREDOR. El CLIENTE declara que esta es la primera oficina que le ha ofrecido estos negocios y se compromete a efectuar toda transacción de las propiedades ofrecidas por su intermedio; si cediera su uso o la información a terceros, pagará igualmente la comisión si estos efectuaren el negocio.',
  },
  {
    n: 5, titulo: 'Aceptación y jurisdicción',
    texto: 'Cualquier dificultad sobre el cobro de la comisión será resuelta por la justicia ordinaria. Si esta orden es enviada por cualquier medio, transcurridas 48 horas sin reclamo por escrito al destinatario, se entenderá irrevocablemente aceptada. El CLIENTE declara haber solicitado y recibido esta orden de la oficina de Fondo Capital Rent Spa, ubicada en Ebro 2791, oficina 1B y 1C, Las Condes, y que cuenta con su autorización y encargo.',
  },
]
