      ...
      {abierto && (
        <>
          ...
          <div onClick={e => e.stopPropagation()} style={flotante
            ? { position: 'fixed', left: fpos.left, top: fpos.top, zIndex: 401, background: '#fff', border: '0.5px solid #D3D1C7', borderRadius: 8, boxShadow: '0 8px 26px rgba(0,0,0,0.16)', width: 272, textAlign: 'left', fontWeight: 400, maxHeight: `calc(100vh - ${fpos.top + 16}px)`, overflowY: 'auto', overflowX: 'hidden' }
            : { position: 'absolute', top: 18, left: 0, zIndex: 31, background: '#fff', border: '0.5px solid #D3D1C7', borderRadius: 8, boxShadow: '0 8px 26px rgba(0,0,0,0.16)', width: 272, textAlign: 'left', fontWeight: 400, overflow: 'hidden' }}>
