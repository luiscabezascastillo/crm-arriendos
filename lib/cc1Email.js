// VERSION: v5 · 2026-08-11 · enviarNotificacion admite `bcc` (copia oculta / CCO), OPCIONAL. Cambio ADITIVO:
//   sin `bcc` el comportamiento es idéntico. Se usa en la reclamación de término. Hereda v4.
...
export async function enviarNotificacion({
  ...
  try {
    ...
    if (cc) mail.cc = cc
    if (bcc) mail.bcc = bcc          // ← NUEVO v5: copia oculta (CCO/BCC), OPCIONAL
