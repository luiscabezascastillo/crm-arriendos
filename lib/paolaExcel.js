// VERSION: v3 · 2026-08-18 · Dos columnas nuevas: ESTADO PAGO (T) y NOTA PAGO (U), manuales, para distinguir
//   PAGADO / pago ATRASADO (el abono visto es de un mes anterior) / NO PAGADO. Así la propietaria ve claro
//   quién pagó de verdad este mes. Hereda v2.
...
const COLUMNAS = [
  ...
  { col: 'T', titulo: 'ESTADO PAGO',     campo: 'estadoPago',    ancho: 15.0 },
  { col: 'U', titulo: 'NOTA PAGO',       campo: 'notaPago',      ancho: 40.0 },
]
...
function construirLeyenda(wb, mesTexto) {
  ...
  const lineas = [
    ...
    ['ESTADO PAGO · NOTA PAGO', 'MANUAL · Administración marca si el arrendatario PAGÓ el mes, si es un PAGO ATRASADO (el abono que se ve es de un mes anterior y el mes en curso sigue pendiente) o si NO HA PAGADO, con una nota aclaratoria.'],
