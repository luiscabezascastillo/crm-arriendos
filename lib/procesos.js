// lib/procesos.js
// VERSION: v4 · 2026-08-18 · Añadido proceso 'Bitácora de estados' (auditoría de cambios de estado de contratos,
//   /procesos/bitacora-estados). Hereda v3.
// VERSION: v3 · 2026-08-18 · Renombrado el proceso 'Término' → 'Términos' (plural) en su titulo. Hereda v2.
// VERSION: v2 · 2026-08-18 · Renombrado proceso 'Inicios Neika' → 'Pagos Iniciales - Neika'
//   (titulo). El key 'inicios_neika' y el href '/procesos/inicios-neika' NO cambian (mantienen permisos y URL).
//   TabTitle lee este `titulo`, así que la pestaña del navegador muestra "Pagos Iniciales - Neika". Hereda v1.
...
export const PROCESOS = [
  ...
  { key: 'cobranza', titulo: 'Cobranza', responsable: 'Administración', participa: ['Finanzas', 'Legal'], frecuencia: 'Puntual', produccion: true,
    descripcion: 'Impago → pago o acción legal',
    etapas: ['Detectar', 'Aviso 1', 'Gestión', 'Legal', 'Cierre'], conecta: null, href: '/op/cobranza' },
  { key: 'notificaciones', titulo: 'Notificaciones', responsable: 'Administración', participa: ['Finanzas'], frecuencia: 'Mensual', produccion: true,
  ...
  // ── MANTENCIÓN ──
  { key: 'incidencia', titulo: 'Incidencia', responsable: 'Mantención', participa: ['Administración', 'Finanzas'], frecuencia: 'Puntual', produccion: true,
  ...
  { key: 'presupuestos', titulo: 'Presupuestos', responsable: 'Mantención', participa: ['Administración', 'Finanzas'], frecuencia: 'Puntual', produccion: true,
  ...
  // ── FINANZAS ──
  { key: 'termino', titulo: 'Términos', responsable: 'Finanzas', participa: ['Administración', 'Legal'], frecuencia: 'Puntual', produccion: true,
  ...
  { key: 'liquidacion', titulo: 'APPVISION/Liquidación', responsable: 'Finanzas', participa: ['Administración'], frecuencia: 'Mensual', produccion: true,
    descripcion: 'Información para liquidación mensual',
    etapas: [], conecta: null, href: '/procesos/liquidaciones' },
  { key: 'liquidacion_paola', titulo: 'Liquidación Paola', responsable: 'Administración', participa: ['Finanzas'], frecuencia: 'Mensual', produccion: true,
  ...
  { key: 'bi_sa', titulo: 'BI', responsable: 'Finanzas', participa: [], frecuencia: 'Semanal', produccion: true,
    ...
    etapas: ['Cargar', 'Sugerir', 'Revisar', 'Volcar'], conecta: null, href: '/procesos/bi/movimientos' },
  { key: 'inicios_neika', titulo: 'Pagos Iniciales - Neika', responsable: 'Ventas', participa: ['Administración', 'Finanzas'], frecuencia: 'Puntual', produccion: true,
    descripcion: 'Registro de los primeros pagos de cada inicio (escribe Neika; consultan Adm./Karina/Anthony)',
    etapas: [], conecta: 'Inicios', href: '/procesos/inicios-neika' },
  { key: 'bitacora_estados', titulo: 'Bitácora de estados', responsable: 'Administración', participa: ['Finanzas', 'Legal'], frecuencia: 'Puntual', produccion: true,
    descripcion: 'Auditoría de cambios de estado de contratos (S/SQ/Q/N): quién lo hizo y cuándo',
    etapas: [], conecta: 'Términos', href: '/procesos/bitacora-estados' },
]
